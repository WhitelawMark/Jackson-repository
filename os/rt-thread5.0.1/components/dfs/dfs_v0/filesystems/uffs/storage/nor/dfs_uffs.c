...
********************************************************************************
*/
static int dfs_uffs_write(struct dfs_file* file, const void* buf, size_t len)
{
    int fd;
    int char_write;
...
********************************************************************************
*/
static int dfs_uffs_seek(struct dfs_file* file, rt_off_t offset)
{
    int result;
...
********************************************************************************
*/
static int dfs_uffs_getdents(struct dfs_file* file, struct dirent* dirp, uint32_t count)
{
    rt_uint32_t index;
    char * file_path;
    struct dirent* d;
