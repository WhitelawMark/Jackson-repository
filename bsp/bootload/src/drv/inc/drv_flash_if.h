...
********************************************************************************
*/
#define FMC_SECTOR_SIZE           ((uint16_t)0x4000)

#define USER_FLASH_END_ADDRESS        0x0801FFFFF                               /* FLASH结束地址定义 modify rong */ 
#define USER_FLASH_SIZE   (USER_FLASH_END_ADDRESS - APPLICATION_ADDRESS + 1)   /* 用户FLASH地址长度定义 */
 
#define APPLICATION_ADDRESS   (uint32_t)0x08020000                             /* 应用程序地址定义 */
#define APPLICATION_HEAD_SIZE (uint32_t)0x200
/*
********************************************************************************
********************************************************************************
*/
...
uint32_t FLASH_If_EraseBlack(uint32_t StartSector,uint32_t ulen);
